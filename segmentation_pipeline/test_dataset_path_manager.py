...
class TestDatasetPathManager:
    def __init__(
        ...
        if test_panoptic_labels_dp is not None:
            self.test_panoptic_labels_dp = os.path.join(
                test_panoptic_labels_dp, self.dataset_name, tile_str
            )
        else:
